...
function Hero () {
  ...
  return (
    <div className=' relative grid sm:grid-cols-2 sm:place-items-center xl:flex xl:justify-between'>
      {heroItems.map((_, index) => (
        <div key={index} className=' p-4 bg-white dark:bg-[#333b44] shadow-md h-[125px] w-60 sm:w-80  rounded-xl flex flex-col justify-center relative'>
