...
export const BarSide = () => {
  return (
    <div className='fixed inset-y-0 flex-wrap items-center justify-between block w-full p-0 my-4 overflow-y-auto antialiased transition-transform duration-200 -translate-x-full  shadow-sm dark:bg-slate-850 max-w-64 ease-nav-brand -z-1 xl:ml-6 rounded-2xl xl:left-0 xl:translate-x-0 ps z-50'>
